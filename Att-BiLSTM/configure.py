...
def parse_args():
    ...
    # Embeddings
    parser.add_argument("--embedding_type", default="random",
                        type=str, help="choose embedding type from random/word2vec/glove/gme")# add by wjn
    ...
    parser.add_argument("--batch_size", default=50,
                        type=int, help="Batch Size (default: 50)")
    ...
    parser.add_argument("--model_dir", default="",
                        type=str, help="model directory from training run")
    # Misc Parameters
    ...
    parser.add_argument("--app_test", default="",
                        type=str, help="when apply for one test  sentence")
